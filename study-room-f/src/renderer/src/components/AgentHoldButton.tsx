...
/**
 * 1:1 — "I have this agent, Jeff stop sending it work."
 *
 ...
 *
 * Never rendered for Jeff himself: telling the orchestrator to stop routing
    ...
    <PixelButton
      ...
      onClick={() => {
        ...
        void Promise.resolve()
          ...
          // optimistically would show a hold Jeff never heard about.
          .then((r) => {
