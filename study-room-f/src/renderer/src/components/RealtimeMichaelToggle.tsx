/**
 * Realtime Jeff — voice toggle + live state indicator (card rt-3, Phase 1).
 *
 * A reusable mic button for the god/orchestrator agent ("Jeff"). It consumes the
 ...
 * Jeff is fullscreen). It is intentionally state-only / hook-only so both can mount it.
 */
