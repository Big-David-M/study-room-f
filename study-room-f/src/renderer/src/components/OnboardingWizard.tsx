...
export function OnboardingWizard({ onComplete }: OnboardingWizardProps) {
  ...
  // choice blind; the first check happened when Jeff spawned, and for a
              ...
              <>
                <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
                  <div style={{
                    ...
                    <SpritePortrait character="jeff" scale={2} />
                  </div>
                  <div>
            ...
            {step === 'orchestrator' && (
              <>
                  ...
                  <span>
                    {plain ? (
                      ...
                      <Trans i18nKey="onboarding.orchestrator.cliAgent" components={{ strong: <strong /> }}>
                        ...
                        sets it up when Jeff first starts.
                        <strong> Your clone</strong> (Jeff) is the engine that orchestrates the whole
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                  ...
                  {/* Engines a WORKER can run but Jeff cannot (issue #355): shown
