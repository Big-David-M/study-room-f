...
export function SettingsModal({ config, onClose, initialSection }: SettingsModalProps) {
  ...
  // Talk (Realtime Jeff) is gated on the OpenAI key — read the live presence
  // boolean so the Realtime Jeff section can show its enabled/disabled status.
            ...
            <>
              <div style={{ display: 'flex', flex: 1, overflow: 'hidden', minHeight: 0 }}>
                ...
                <div style={{
                  ...
                  {/* VOICE — Free Flow dictation + Realtime Jeff (v0.3.4: its own tab) */}
                  {activeSection === 'Voice' && (
                    <>
                      ...
                      {/* Realtime Jeff — voice device selection (rt-8) */}
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                        <div style={sectionHeadTight}>
