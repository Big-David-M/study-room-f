    ...
    <div style={{
      ...
      <div style={{ flex: 1, minHeight: 0, display: 'flex' }}>
        ...
        <div style={{
          ...
          {agent.isGod ? (
            // Jeff runs the floor from the command center — its tabs (tasks,
...
function Header({ agent, onEdit }: { agent: Agent; onEdit: () => void }) {
   ...
   *  button would read as "restart Jeff" while looking like "close". */
  const onKill = async () => {
  ...
  return (
    <div style={{
      ...
      <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 6 }}>
        ...
        {/* Voice toggle is ALWAYS reachable in fullscreen — it controls Jeff (the
            ...
            HUD stays Jeff-only (it belongs to his card). */}
