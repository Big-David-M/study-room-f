...
export function OfficeFloor() {
  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      // selects Jeff (the god) and opens the Command Center's TRIGGERS tab —
      ...
      // Seat 0 is desk-ceo — "Jeff's room" — reserved for the god agent.
      ...
      const updateErrands = (dt: number): void => {
        ...
        const spot = ERRAND_SPOTS[idx];
        // Pick the performer. The CEO office's spots belong to Jeff alone —
      ...
      // ─── The boss aura: performative excellence in Jeff's presence ──────
      ...
      // Jeff. raise?" with N from the actual ledger). What they say once
      ...
      // Jeff and opens the Command Center's tasks tab.
      ...
      // The wall clock beside Jeff's window doubles as the quit entry:
      ...
      // Jeff walks over and pins fresh cards; an assigned worker walks to
