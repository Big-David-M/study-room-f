...
export interface HarnessConfig {
  ...
  autoMode: boolean;
  /** May the orchestrator ("Jeff") spin up agents on its own? Default FALSE,
...
/** The Sonnet model with the 1M-token context window — used for Jeff's prep
 ...
 *    Luna is the cheap, high-context default for Jeff; the rest are curated
 ...
 *  run Jeff, because the orchestrator must drain hive mail. So the step now
