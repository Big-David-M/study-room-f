/**
 * Realtime Jeff — voice session cost HUD (card rt-9, cost-guard).
 *
 ...
 * near the voice toggle (Jeff's card / fullscreen header) — it renders its own
 ...
 *    so the user (and Jeff, who can read get_cost) knows to wrap up. The actual
