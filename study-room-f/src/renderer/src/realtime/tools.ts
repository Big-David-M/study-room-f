/**
 * Realtime Jeff — read-tools (rt-4, Realtime Jeff Phase 1).
 *
  ...
  return [
    ...
    tool({
      ...
      parameters: {
        type: 'object',
        properties: {
          agentId: { type: 'string', description: 'The agent id or friendly name to look up (e.g. "troy-mqpbq43v" or "Troy").' }
        },
        required: ['agentId'],
        additionalProperties: false
      },
...
/**
 * A short, preloaded orientation Jeff can open the session with — the hive
