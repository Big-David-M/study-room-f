/**
 * Realtime Jeff — completion toast (card rt-12, Phase 2, the visual half of
 * "respond when done").
 *
 * When voice-Jeff dispatches work fire-and-notify, main detects completion (see
 * src/main/realtimeCompletionWatcher.ts) and — while a session is live — pushes the
 * event to the renderer over the `realtime:completion` channel. Jeff SPEAKS it; this
 ...
 *  human-speakable line Jeff relays; the rest is context for this toast. */
