...
export interface AgentMeta {
  ...
  cwd: string;
  isGod?: boolean;
  /** Jeff's prep assistant — enriches prompts and forwards them to Jeff.
...
export interface RegistryAgent extends AgentMeta {
  ...
  archived?: boolean;
  /** The human has this agent 1:1 and Jeff must leave it alone until they
...
export class HiveManager {
  ...
  ensureHive(): void {
    ...
    // The Claude Code command reference Jeff consults (refreshed each bootstrap
   ...
   */
  /**
   * Put an agent on hold, or take it off, and tell Jeff immediately.
   *
  ...
  /** Write the live fleet snapshot Jeff reads (`fleet.json`, gitignored).
   ...
   * lived solely in a UI terminal pane. Observed live 2026-08-24: Jeff's
