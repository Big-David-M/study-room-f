/**
 * Realtime Jeff — completion watcher (card rt-12, Phase 2, "respond when done").
 *
 * When voice-Jeff DISPATCHES work (fire-and-notify, the default pattern), he does
 ...
 * make Jeff speak it unprompted ("Oscar finished — want details?").
 *
...
/** A unit of work voice-Jeff dispatched and is now awaiting completion of. */
 ...
 * field here reaches Jeff. `summary` is the human-speakable line; `completedAt` is
 ...
 * whitespace, and cap length so a malicious objective can't steer what Jeff says or does.
