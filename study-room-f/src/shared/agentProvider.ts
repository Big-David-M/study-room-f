...
export interface AgentProviderPreset {
  ...
  /** The model the GOD orchestrator ("Jeff") defaults to when this provider
   *  powers it — surfaced as the picker default and the advisory "give Jeff a
...
export const AGENT_PROVIDER_PRESETS: AgentProviderPreset[] = [
  {
    ...
    // Longest-context Claude variant — matches the "give Jeff a bigger model"
  ...
  },
  {
    ...
    // NOT use `-p` so Jeff and workers remain god-eligible / inbox-capable.
