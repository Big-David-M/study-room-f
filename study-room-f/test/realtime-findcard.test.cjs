...
const TASKS = [
  ...
  { id: 'rt-2-realtime-session', title: 'Realtime Jeff 2: WebRTC session — mic capture, VAD, barge-in', status: 'done' },
  { id: 'rt-3-toggle-ui', title: 'Realtime Jeff 3: mic toggle + live state dot on AgentCard', status: 'done' },
